      ...
      <div class="mx-auto max-w-5xl">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          ...
          <div class="flex items-center gap-3">
            <!-- Excel -->
            <button
              class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold text-slate-900 bg-white shadow-lg shadow-slate-900/20 transition hover:bg-slate-200 hover:scale-[1.02] active:scale-[0.98]"
            >
            ...
            <!-- PDF -->
            <button
              class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold text-white transition shadow-lg shadow-violet-900/20 hover:opacity-90 hover:scale-[1.02] active:scale-[0.98]"
            ...
            <table class="w-full text-left border-collapse">
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="py-4 px-6 text-sm font-bold text-white whitespace-nowrap text-right">
                    {{ row.revenue.toLocaleString('ru-RU') }} ₽
                  </td>
                  <td class="py-4 px-6 text-sm font-semibold text-emerald-400 whitespace-nowrap text-right">
                    {{ row.authorShare }}%
                  </td>
                  <td class="py-4 px-6 text-sm font-semibold text-amber-400 whitespace-nowrap text-right">
                    {{ row.labelShare }}%
                  </td>
                </tr>
              </tbody>
